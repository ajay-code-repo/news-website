            ...
            <div class="col-md-8">
                ...
                <?php 
                        ...
                        ?>
                         ...
                         <?php
                        $sql="SELECT * FROM post LEFT JOIN category ON post.category=category.category_id LEFT JOIN user ON post.author=user.user_id WHERE post.category={$catid} ORDER BY post.post_id DESC LIMIT {$offset},{$limit}";
